...
import { ConfettiProps } from '@/interfaces/interfaces'
...
export default function BirthdayComponent({ name }: {name :string}) {
  ...
  return (
    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      ...
      >
        <Card className="mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl border-2 border-black">
          <CardHeader className="text-center">
            ...
            <p className="text-lg text-gray-500">{new Date().toLocaleDateString()}</p>
          </CardHeader>
      ...
      <audio ref={audioRef} id='song' src="/musics/happyBirthday.wav">
      </audio>
    </div>
  )
}
